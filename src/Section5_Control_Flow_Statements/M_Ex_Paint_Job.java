...
public class M_Ex_Paint_Job {
    public static void main(String[] args) {
        System.out.println(getBucketCount(10,5,5));
    }

    public static int getBucketCount(double totalArea, double areaPerBucket) {
        if (totalArea <= 0.0d || areaPerBucket <= 0.0d) {
            return -1;
        }
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket, int extraBuckets) {
        ...
        return (extraBuckets >= bucketsNeeded) ? 0 : (bucketsNeeded - extraBuckets);

    }


//OTHER SOLUTION USING TERNARY OPERATORS
