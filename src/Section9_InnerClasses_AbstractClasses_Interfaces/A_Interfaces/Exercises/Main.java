...
//    Create a simple
//
//interface that allows an object to be saved to some sort of storage medium.
//
...
//
//            - read(),same as interface.Store the values in the List,in the order they appear in toString().Make sure the List is not null and the size()is greater than 0before storing the values.
//
